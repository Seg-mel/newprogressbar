...
class MainScreen(BoxLayout):
    ...
    def __init__(self):
        ...
        self.add_widget(Label(text=''))
        self.my_prbar.set_spacing(4)
        self.my_prbar.set_background_color(color='#111888')
        self.my_prbar.set_color('#222aaa')
        # self.my_prbar.set_max(100)
        # self.my_prbar.set_bar_value_percent(0)
        # self.my_prbar.set_bar_value(4)
        self.my_prbar.set_border_color('finish', '#444fff')
        self.my_prbar.set_border_color('start', '#444fff')
        self.my_prbar.set_height(value=10)
